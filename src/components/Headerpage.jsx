...
const teamMembers = [
{
  ...
  },
   {
    ...
    role: "Vice President",
    linkedin: "https://www.linkedin.com/in/sampreeti-rastogi-868612325?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    image: img14,
  },
   {
    name: "Chetan Kumar",
  ...
  },
  {
    ...
    role: "Web Development Department",
  ...
  },
  {
    name: "Mohit Aggarwal",
    role: "PR Department",
    linkedin: "https://www.linkedin.com/in/mohitaggarwal551?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    image: img2,
  },
  {
    name: "Aditi Mishra",
...
const Header = () => {
  ...
  const prevPage = () => {
    setCurrentPage((prev) => (prev === 0 ? teamMembers.length - 1 : prev - 1));
  };
    ...
    <div className="min-h-screen bg-cosmic-900 text-white">
      ...
      <div className="relative min-h-screen flex flex-col md:flex-row items-center justify-between px-4 md:px-16 py-12 md:py-20 gap-8">
        ...
        <div className="flex-1 z-10 text-center md:text-left">
          ...
          <div className="space-y-3 md:space-y-4 text-base md:text-xl">
            ...
            <p className="text-yellow-500 font-bold text-2xl">The Council of Leads</p>
      ...
      <div className="min-h-screen flex items-center justify-center px-8 py-20 relative">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 text-9xl text-yellow-600">ॐ</div>
          <div className="absolute bottom-20 right-20 text-9xl text-yellow-600">🕉</div>
          <div className="absolute top-1/2 left-10 text-6xl text-yellow-600">🔱</div>
          <div className="absolute top-1/3 right-10 text-6xl text-yellow-600">🔱</div>
        </div>
          ...
          <div className="hidden md:block relative perspective-1000">
            <div className="relative bg-gradient-to-br from-amber-950/60 via-amber-900/60 to-amber-950/60 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] p-8 border-4 border-yellow-600/40 backdrop-blur-sm">
              ...
              <div className="absolute left-1/2 top-0 bottom-0 w-4 bg-gradient-to-r from-black/60 via-black/80 to-black/60 transform -translate-x-1/2 z-10">
                <div className="absolute top-1/4 left-1/2 -translate-x-1/2 text-yellow-600/70 text-xs">🕉</div>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 text-yellow-600/70 text-xs">🔱</div>
                <div className="absolute top-3/4 left-1/2 -translate-x-1/2 text-yellow-600/70 text-xs">🕉</div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 min-h-[500px] mt-8 mb-8">
                ...
                <div className="flex items-center justify-center p-8 bg-gradient-to-br from-amber-100/20 via-amber-200/15 to-amber-100/20 rounded-l-2xl relative overflow-hidden shadow-inner backdrop-blur-sm border border-yellow-600/30">
                  ...
                  {/* Corner Decorations */}
                  <div className="absolute top-4 left-4 text-2xl text-yellow-600/40">❀</div>
                  <div className="absolute top-4 right-4 text-2xl text-yellow-600/40">❀</div>
                  <div className="absolute bottom-4 left-4 text-2xl text-yellow-600/40">❀</div>
                  <div className="absolute bottom-4 right-4 text-2xl text-yellow-600/40">❀</div>
                  
                  <div className="relative">
                    <img
                      src={teamMembers[currentPage].image}
                      alt={teamMembers[currentPage].name}
                ...
                <div className="flex flex-col justify-center p-12 bg-gradient-to-br from-amber-100/20 via-amber-200/15 to-amber-100/20 rounded-r-2xl relative shadow-inner backdrop-blur-sm border border-yellow-600/30">
                  ...
                  <div className="relative space-y-6 z-10">
                    ...
                    <p className="text-xl text-amber-200 font-serif leading-relaxed italic">
                      {teamMembers[currentPage].role}
                    </p>
                    
                    {/* LinkedIn Button with Veda styling */}
                    <a
                      href={teamMembers[currentPage].linkedin}
                      target="_blank"
