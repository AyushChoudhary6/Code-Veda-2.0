      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end mb-32 relative">
          ...
          <div className="order-2 md:order-1 relative group">
            <div className="glass-card rounded-3xl p-8 text-center transform transition-all duration-500 hover:-translate-y-2 border-t-4 border-gray-400 bg-cosmic-800/50 backdrop-blur-sm border border-gray-400/20">
          ...
          <div className="order-1 md:order-2 relative z-10 group">
            <div className="glass-card rounded-3xl p-10 text-center transform transition-all duration-500 hover:-translate-y-4 border-t-4 border-yellow-500 bg-cosmic-800/60 backdrop-blur-sm border border-yellow-500/30 shadow-[0_0_30px_rgba(255,215,0,0.1)]">
          ...
          <div className="order-3 relative group">
            <div className="glass-card rounded-3xl p-8 text-center transform transition-all duration-500 hover:-translate-y-2 border-t-4 border-orange-400 bg-cosmic-800/50 backdrop-blur-sm border border-orange-400/20">
              <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-40 h-40 animate-float-delayed">
                <img
